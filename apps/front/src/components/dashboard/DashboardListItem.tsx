    ...
    <div className="bg-[#161b22]/30 border border-[#30363d] rounded-xl p-4 flex items-center gap-4 hover:border-[#3b82f6]/30 hover:bg-[#161b22]/50 transition-all group">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-1">
        ...
        <div className="flex items-center gap-3 mt-1">
          <span className="text-[#8b949e] text-caption font-medium uppercase tracking-tight">创建者 @{creator}</span>
          <span className="text-[#8b949e] text-caption font-medium uppercase tracking-tight">{saves.toLocaleString()} 保存</span>
