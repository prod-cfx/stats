  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="space-y-6">
        ...
        />
        <button className="flex items-center gap-2 px-4 py-1.5 bg-[#1e1e1e] border border-[#3a3a3a] rounded-md text-[#cccccc] text-label hover:border-[#3b82f6]/50 transition-all">
