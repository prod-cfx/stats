...
describe('AiQuantStrategyDetail', () => {
  ...
  it('renders running controls as an integrated horizontal action group', async () => {
    ...
    expect(returnLink?.className).toContain('rounded-full')
    expect(returnLink?.className).toContain('px-3.5')
    expect(returnLink?.className).toContain('py-1.5')
    expect(returnLink?.className).toContain('text-xs')
    expect(returnLink?.className).toContain('leading-5')
    ...
    expect(stopButton?.className).toContain('px-3.5')
    expect(stopButton?.className).toContain('py-1.5')
    expect(stopButton?.className).toContain('text-xs')
    expect(stopButton?.className).toContain('leading-5')
