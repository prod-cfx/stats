...
describe('QuantChatPanel range settings', () => {
  ...
  it('exposes mobile-safe shell, toolbar, and message wrapping classes', async () => {
    ...
    expect(toolbar?.querySelector('h2')?.className).toContain('truncate')
    expect(toolbar?.querySelector('h2')?.parentElement?.className).toContain('flex-1')
    expect(toolbar?.lastElementChild?.className).toContain('ml-auto')
