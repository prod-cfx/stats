    ...
    <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 flex flex-col gap-5 h-full">
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex justify-between items-center">
          <span className="text-[#8b949e] text-sm font-medium">永续合约总价值</span>
          <span className="px-2 py-0.5 bg-[#30363d] text-[#8b949e] text-[10px] font-bold rounded uppercase">当前持仓</span>
        </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <span className="text-[#8b949e] text-sm">平均保证金使用率</span>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center border-b border-[#30363d]/50 pb-2">
          <span className="text-[#8b949e] text-sm font-medium">方向偏差</span>
          <span className="text-[#8b949e] text-sm font-medium">中性</span>
        </div>
        
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center text-xs">
              <span className="text-[#8b949e] font-medium">多头持仓</span>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center text-xs">
              <span className="text-[#8b949e] font-medium">空头持仓</span>
      ...
      {/* Value Distribution */}
      <div className="flex flex-col gap-3">
        <div className="text-[#8b949e] text-sm font-medium border-b border-[#30363d]/50 pb-2">仓位分布</div>
        <div className="flex justify-between items-end">
          <div className="flex flex-col gap-0.5">
            <span className="text-[#8b949e] text-[10px] font-medium uppercase">多头价值</span>
            <span className="text-white text-base font-bold">$ 0</span>
          </div>
          <div className="flex flex-col items-end gap-0.5">
            <span className="text-[#8b949e] text-[10px] font-medium uppercase">空头价值</span>
      ...
      <div className="flex flex-col gap-2 pt-3 mt-auto border-t border-[#30363d]">
        <div className="flex justify-between items-center">
          <span className="text-[#8b949e] text-sm">投资回报率</span>
          <span className="text-red-500 text-base font-bold">-7.63 %</span>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-[#8b949e] text-sm">未实现盈亏</span>
