    ...
    <div className="space-y-12">
      ...
      <div className="flex flex-wrap items-center gap-4 py-6">
        {['胜率', '账户总价值', '已实现盈亏'].map((filter) => (
          <button 
            key={filter}
            className="px-6 py-2.5 bg-[#161b22] border border-[#30363d] rounded-xl text-[#c9d1d9] text-label font-bold flex items-center gap-3 hover:border-[#3b82f6]/50 transition-colors"
          >
            {filter}
