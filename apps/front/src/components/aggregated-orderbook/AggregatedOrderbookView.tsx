          ...
          <>
            ...
            <div className={`flex-1 flex ${isCompact ? 'min-h-fit' : 'min-h-0'} overflow-hidden`}>
              <div className={`${isCompact ? 'w-[58%] min-h-fit' : 'w-1/2 flex flex-col'} border-r border-[#30363d]`}>
                <div className={`${isCompact ? 'p-1' : 'p-4'} border-b border-[#30363d] flex items-center justify-between bg-[#0d1117]/20 flex-none`}>
                  <SectionTitle className={isCompact ? 'text-[8px] leading-tight' : 'text-lg'}>
              ...
              <div className={`${isCompact ? 'w-[42%] min-h-fit' : 'w-1/2 flex flex-col min-h-0'}`}>
                <div className={`${isCompact ? 'p-1' : 'p-4'} border-b border-[#30363d] flex items-center justify-between bg-[#0d1117]/20 flex-none`}>
                  <SectionTitle className={isCompact ? 'text-[8px] leading-tight' : 'text-lg'}>{t('aggregatedOrderbook.sections.orderDepth')}</SectionTitle>
                  {!isCompact && (
                ...
                <div className={`flex-1 min-h-0 ${isCompact ? 'p-1' : 'p-4'} flex flex-col`}>
                  <div className="flex-1 min-h-0">
                    <DepthChart bids={depthChartData.bids} asks={depthChartData.asks} variant={variant} />
                  </div>
                  {!isCompact && (
