...
export const TradingViewChart = forwardRef((
  ...
  ref: ForwardedRef<ChartingLibraryChartRef>,
) => {
  ...
  return (
    <div className="w-full h-full min-h-[500px] bg-[color:var(--cf-bg)]">
      ...
      <noscript>
        <div className="w-full h-full min-h-[500px] flex items-center justify-center text-[color:var(--cf-muted)]">
