    ...
    <div className="relative flex min-h-0 w-full flex-1 flex-col overflow-hidden bg-[color:var(--cf-bg)]">
      ...
      {isIndicatorModalOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
          <div
            className={`${isCompact ? 'h-[300px] w-[400px]' : 'h-[400px] w-[600px]'} max-h-[calc(100dvh-2rem)] max-w-[calc(100vw-2rem)] flex flex-col overflow-hidden rounded-lg border border-[color:var(--cf-border)] bg-[color:var(--cf-surface)] shadow-sm`}
          >
            {/* Modal Header */}
            <div
            ...
            >
              <span
                className={`!font-semibold !leading-[22px] text-[color:var(--cf-text)] ${isCompact ? '!text-xs' : '!text-[15px]'}`}
              >
                ...
                <div className="cf-scrollbar flex flex-1 flex-col gap-0.5 overflow-y-auto">
                  {visibleIndicators.map(ind => (
                    ...
                    >
                      ...
                      <div
                        className={`!text-xs !font-semibold !leading-5 ${ind.isActive ? 'text-white' : 'text-[color:var(--cf-muted)]'}`}
                      >
                  ...
                  {visibleIndicators.length === 0 && (
                    <div className="px-3 py-5 text-center !text-xs !font-normal !leading-5 text-[color:var(--cf-muted)]">
