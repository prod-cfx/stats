      ...
      >
        ...
        <div className="p-3 border-t border-[#30363d]">
          <button
            ...
            className="w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white font-medium py-3 rounded-lg transition-all shadow-lg shadow-primary/20 active:scale-95 flex items-center justify-center gap-2"
          >
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {currentTab === 'explore' ? (
            ...
            <div className="text-center text-[#8b949e] py-20">
              ...
              <button
                onClick={handleCreateDashboard}
                className="mt-4 bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-white px-6 py-2 rounded-lg transition-all shadow-lg shadow-primary/20 active:scale-95"
              >
                创建第一个看板
              </button>
            </div>
