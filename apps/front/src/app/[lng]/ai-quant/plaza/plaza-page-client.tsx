  ...
  return (
    <main className="mx-auto flex w-full max-w-[1120px] flex-1 flex-col gap-6 px-4 py-8 md:px-8">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-[color:var(--cf-text-strong)]">策略广场</h1>
          <p className="mt-1 text-sm text-[color:var(--cf-muted)]">登录后可从策略广场直接运行，或带入对话持续优化。</p>
        </div>
        <Link
          href={`/${lng}/ai-quant`}
      ...
      <StrategyPlaza
        subtitle="选择策略后可直接回测运行，或进入对话继续调参。"
