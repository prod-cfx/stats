...
-- CreateEnum
CREATE TYPE "public"."LlmCodegenSessionStatus" AS ENUM ('DRAFTING', 'CHECKLIST_GATE', 'GENERATING', 'VALIDATING_STATIC', 'VALIDATING_RUNTIME', 'VALIDATING_OUTPUT', 'PUBLISHED', 'REJECTED');
