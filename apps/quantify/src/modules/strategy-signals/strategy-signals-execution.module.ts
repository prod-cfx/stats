...
@Module({
  imports: [PrismaModule, AccountsModule, PositionsModule, TradingModule, TradingExecutionModule, StrategyInstancesModule, StrategySignalsGenerationModule, ConfigModule.forFeature(strategySignalsConfig)],
