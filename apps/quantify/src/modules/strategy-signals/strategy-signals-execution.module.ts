...
@Module({
  ...
  providers: [SignalExecutorService, SignalExecutionRepository, FixedBinanceTestnetSignalService, FixedOkxSimulatedSignalService],
  exports: [SignalExecutorService, FixedBinanceTestnetSignalService, FixedOkxSimulatedSignalService],
})
