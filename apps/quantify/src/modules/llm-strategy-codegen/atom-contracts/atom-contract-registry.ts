  ...
  'price.candle_pattern': {
    ...
    surface: {
      ...
      paramSlots: {
        ...
        pattern: { kind: 'enum', required: true, enum: ['engulfing', 'hammer', 'doji', 'consecutive_body', 'single_bull_bar', 'single_bear_bar'], extractor: { kind: 'enum-zh-map', enumMap: { '吞没': 'engulfing', 'engulfing': 'engulfing', '锤子': 'hammer', 'hammer': 'hammer', '十字星': 'doji', 'doji': 'doji', '连续阳线': 'consecutive_body', '连续阴线': 'consecutive_body', 'consecutive body': 'consecutive_body', '连续': 'consecutive_body', '阳线': 'single_bull_bar', 'bullish': 'single_bull_bar', 'bullish_candle': 'single_bull_bar', 'green_candle': 'single_bull_bar', 'candle_up': 'single_bull_bar', 'close_gt_open': 'single_bull_bar', '收盘价高于开盘价': 'single_bull_bar', '收盘高于开盘': 'single_bull_bar', '收盘价高于开盘': 'single_bull_bar', '阴线': 'single_bear_bar', 'bearish': 'single_bear_bar', 'bearish_candle': 'single_bear_bar', 'red_candle': 'single_bear_bar', 'candle_down': 'single_bear_bar', 'close_lt_open': 'single_bear_bar', '收盘价低于开盘价': 'single_bear_bar', '收盘低于开盘': 'single_bear_bar', '收盘价低于开盘': 'single_bear_bar' } } },
  ...
  'grid.range_rebalance': {
    ...
    surface: {
      ...
      paramSlots: {
        ...
        sideMode: { kind: 'enum', required: false, enum: ['long_only', 'short_only', 'both'], default: 'both', extractor: { kind: 'enum-zh-map', enumMap: { '只做多': 'long_only', '仅做多': 'long_only', '只做空': 'short_only', '仅做空': 'short_only', '双向': 'both', 'bidirectional': 'both', '反向单': 'both', '相邻网格': 'both', '相邻反向': 'both', '对冲': 'both' } } },
