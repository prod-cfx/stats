...
export const actionAddPositionUtterances = [
  ...
  },
  {
    ...
    expected: {
      ...
      key: 'action.add_position',
      status: 'locked',
      params: { addMode: 'profit_pct', profitThreshold: 5 },
  ...
  },
  {
    ...
    expected: {
      ...
      key: 'action.add_position',
      status: 'locked',
      params: { addMode: 'drawdown_pct', addRatio: 0.3, drawdownThreshold: 5 },
      openSlotKeys: [],
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ...
      key: 'action.add_position',
      status: 'locked',
      params: { addMode: 'profit_pct', addRatio: 0.2, profitThreshold: 2 },
      openSlotKeys: [],
    },
  },
