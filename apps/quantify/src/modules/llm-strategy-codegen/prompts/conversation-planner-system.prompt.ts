export function buildConversationPlannerSystemPrompt(): string {
  return [
    ...
    '当逻辑不完整时，clarificationIntent 必须指向未闭合的 semantic slots。',
    ...
    '3) 若任一必答项，或阈值/时间窗口/序列条件的比较基准仍不明确：logicReady=false，clarificationIntent 必须指向未闭合语义槽。',
