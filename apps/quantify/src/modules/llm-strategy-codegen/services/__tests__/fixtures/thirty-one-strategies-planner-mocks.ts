        ...
        rules: [
          {
            ...
            phase: 'entry',
            sideScope: 'long',
            condition: atom('external_signal', { signalId: 'entry-long', secret: 'SECRET_PLACEHOLDER' }),
            effects: [atom('open_long', { positionPct: 10 })],
          },
          {
            id: 'r25-exit',
            phase: 'exit',
            sideScope: 'long',
            condition: atom('external_signal', { signalId: 'exit-long', secret: 'SECRET_PLACEHOLDER' }),
            effects: [atom('close_long')],
          },
        ],
      },
