        ...
        rules: [
          {
            ...
            phase: 'entry',
            sideScope: 'long',
            condition: atom('price.rolling_extrema_breakout', { lookbackBars: 20, extrema: 'high', event: 'breakout_up' }),
            effects: [atom('open_long')],
          },
          {
            id: 'r16-exit',
            phase: 'exit',
            sideScope: 'long',
            condition: atom('price.rolling_extrema_breakout', { lookbackBars: 10, extrema: 'low', event: 'breakout_down' }),
            effects: [atom('close_long')],
          },
        ],
      },
