...
const PRESENTATIONS: SemanticPresentationMetadata[] = [
  ...
  presentation({
    ...
    negativeExamples: ['平掉多单'],
    goldenUtterances: ['条件满足时开多'],
    displayRenderer: () => renderDisplayToken('atom.action.open_long.name'),
  }),
  presentation({
    key: 'open_short',
    publicName: '开空',
  ...
  presentation({
    ...
    negativeExamples: ['平掉空单'],
    goldenUtterances: ['条件满足时开空'],
    displayRenderer: () => renderDisplayToken('atom.action.open_short.name'),
  }),
  presentation({
    key: 'close_long',
    publicName: '平多',
  ...
  presentation({
    ...
    negativeExamples: ['继续加多仓'],
    goldenUtterances: ['多单触发止损时平仓'],
    displayRenderer: () => renderDisplayToken('atom.action.close_long.name'),
  }),
  presentation({
    key: 'close_short',
    publicName: '平空',
  ...
  presentation({
    ...
    negativeExamples: ['继续加空仓'],
    goldenUtterances: ['空单触发止损时平仓'],
    displayRenderer: () => renderDisplayToken('atom.action.close_short.name'),
  }),
  presentation({
    key: 'close_position',
    publicName: '平仓',
