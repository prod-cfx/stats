...
const REASON_PRIORITY: Record<StrategyClarificationItem['reason'], number> = {
  ...
  missing_semantic_contract_substrate: 5,
  missing_semantic_contract_runtime_requirement: 5,
  missing_semantic_contract_state_requirement: 5,
  missing_semantic_contract_order_requirement: 5,
