...
export const marketDataConfig = registerAs('marketData', () => ({
  ...
  okxRestBaseUrl: env.str('MARKET_DATA_OKX_REST_BASE_URL', 'https://www.okx.com'),
  okxWsBaseUrl: env.str('MARKET_DATA_OKX_WS_BASE_URL', 'wss://ws.okx.com:8443/ws/v5/public'),
  hyperliquidRestBaseUrl: env.str('MARKET_DATA_HYPERLIQUID_REST_BASE_URL', 'https://api.hyperliquid.xyz'),
  hyperliquidWsBaseUrl: env.str('MARKET_DATA_HYPERLIQUID_WS_BASE_URL', 'wss://api.hyperliquid.xyz/ws'),
