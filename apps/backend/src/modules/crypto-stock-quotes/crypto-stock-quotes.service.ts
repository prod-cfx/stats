...
export class CryptoStockQuotesService {
  ...
  private toResponseDto(entity: CryptoStockQuote): CryptoStockQuoteResponseDto {
    ...
    return {
      ...
      // 优先使用数据库字段，回退到静态配置
      mNav: entity.mNav != null ? entity.mNav.toString() : (config?.mNav ?? null),
      holdingValue: entity.holdingValue != null ? entity.holdingValue.toString() : null,
      holdingQuantity: entity.holdingQuantity != null ? entity.holdingQuantity.toString() : null,
