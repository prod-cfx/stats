...
@Injectable()
export class OkxCexFutureOrderbookWsAdapter extends OkxOrderbookWsAdapterBase {
  readonly key = 'OKX.CEX.FUTURE' as const

  protected readonly venueId = 'okx-future'
