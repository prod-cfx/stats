...
@Injectable()
export class BitmaxCexPerpetualOrderbookWsAdapter extends BitmaxOrderbookWsAdapterBase {
  readonly key = 'BITMAX.CEX.PERPETUAL' as const

  protected readonly venueId = 'bitmax-perp'
  ...
  protected getMaxStreamsPerConnection(): number {
    return (
      this.configService.get<number>('ORDERBOOK_WS_BITMAX_PERPETUAL_MAX_STREAMS_PER_CONNECTION') ??
