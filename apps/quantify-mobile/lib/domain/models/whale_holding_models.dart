/// 巨鲸「持仓」tab 持仓明细领域模型（#2190，源自 #1790）。
///
/// domain 层：作为 UI 唯一消费来源。对齐设计稿 `WhaleHoldings`
/// （`WHALE_HOLDINGS`）：展示串与排序数值并存——展示字段保持已格式化字符串
/// （沿用 mock fixture 约定，如 `valueDisplay: '$1.55亿'`），额外携带数值字段
/// （[value]/[pnl]/[margin]/[hoursAgo]）供筛选与排序在 tab 本地态即时完成。
///
/// 筛选/排序等业务派生纯函数已迁出至 `domain/use_cases/whale_holding_use_cases.dart`。
library;
