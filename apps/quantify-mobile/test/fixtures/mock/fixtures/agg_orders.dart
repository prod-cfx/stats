...
const Map<String, Color> kVolColor = <String, Color>{
  'BIN': Color(0xFF7C5CFF),
  'OKX': Color(0xFFE5484D),
  'MEX': Color(0xFFF5A524),
  'BYB': Color(0xFF16A36B),
  'GT': Color(0xFF22D3EE),
  'BTX': Color(0xFF3B82F6),
  'BG': Color(0xFFA78BFA),
  'CB': Color(0xFFE5484D),
  'WBT': Color(0xFFF5A524),
  'HL': Color(0xFF16A36B),
  'BIX': Color(0xFF3B82F6),
  'APX': Color(0xFFEC4899),
  'CRP': Color(0xFF10B981),
  'AST': Color(0xFFF97316),
  'EDX': Color(0xFFEC4899),
  'LGT': Color(0xFFA78BFA),
  'DER': Color(0xFFE5484D),
  'HTX': Color(0xFF3B82F6),
  'KRK': Color(0xFF5841D8),
  'KC': Color(0xFF22D896),
  'LB': Color(0xFF94A3B8),
  'EXT': Color(0xFF94A3B8),
  'BMX': Color(0xFF1F2937),
  'CEX': Color(0xFF2EB8AA),
  'DYX': Color(0xFF6966FF),
  'BFX': Color(0xFF94A3B8),
  'PRD': Color(0xFF94A3B8),
  'DFT': Color(0xFF94A3B8),
  'TOTAL': Color(0xFF3B82F6),
};
...
final Map<String, VolSnapshot> kVolData = <String, VolSnapshot>{
  'BTC': const VolSnapshot(
    total: 63.39,
    rows: <VolRow>[
      VolRow(exchange: 'BIN', value: 15.48),
      VolRow(exchange: 'OKX', value: 7.47),
      VolRow(exchange: 'MEX', value: 6.31),
      VolRow(exchange: 'BYB', value: 5.50),
      VolRow(exchange: 'GT', value: 4.93),
      VolRow(exchange: 'BTX', value: 3.91),
      VolRow(exchange: 'BG', value: 3.19),
      VolRow(exchange: 'CB', value: 2.61),
      VolRow(exchange: 'WBT', value: 2.49),
      VolRow(exchange: 'HL', value: 2.22),
      VolRow(exchange: 'BIX', value: 1.55),
      VolRow(exchange: 'APX', value: 1.13),
      VolRow(exchange: 'CRP', value: 0.99),
      VolRow(exchange: 'AST', value: 0.96),
      VolRow(exchange: 'EDX', value: 0.88),
      VolRow(exchange: 'LGT', value: 0.81),
      VolRow(exchange: 'DER', value: 0.49),
      VolRow(exchange: 'HTX', value: 0.44),
      VolRow(exchange: 'KRK', value: 0.36),
      VolRow(exchange: 'KC', value: 0.33),
      VolRow(exchange: 'EXT', value: 0.32),
      VolRow(exchange: 'LB', value: 0.31),
      VolRow(exchange: 'BMX', value: 0.22),
      VolRow(exchange: 'CEX', value: 0.18),
      VolRow(exchange: 'DYX', value: 0.16),
      VolRow(exchange: 'BFX', value: 0.08),
      VolRow(exchange: 'PRD', value: 0.04),
      VolRow(exchange: 'DFT', value: 0.02),
    ],
  ),
  'ETH': const VolSnapshot(
    total: 51.70,
    rows: <VolRow>[
      VolRow(exchange: 'BIN', value: 14.45),
      VolRow(exchange: 'OKX', value: 9.38),
      VolRow(exchange: 'GT', value: 5.45),
      VolRow(exchange: 'BTX', value: 4.89),
      VolRow(exchange: 'BYB', value: 3.56),
      VolRow(exchange: 'MEX', value: 2.54),
      VolRow(exchange: 'BG', value: 2.44),
      VolRow(exchange: 'WBT', value: 1.74),
      VolRow(exchange: 'CB', value: 1.59),
      VolRow(exchange: 'HL', value: 0.90),
      VolRow(exchange: 'BIX', value: 0.86),
      VolRow(exchange: 'EDX', value: 0.84),
      VolRow(exchange: 'HTX', value: 0.76),
      VolRow(exchange: 'AST', value: 0.66),
      VolRow(exchange: 'CRP', value: 0.34),
      VolRow(exchange: 'KC', value: 0.25),
      VolRow(exchange: 'LB', value: 0.23),
      VolRow(exchange: 'EXT', value: 0.19),
      VolRow(exchange: 'DER', value: 0.12),
      VolRow(exchange: 'LGT', value: 0.12),
      VolRow(exchange: 'APX', value: 0.12),
      VolRow(exchange: 'BMX', value: 0.09),
      VolRow(exchange: 'KRK', value: 0.09),
      VolRow(exchange: 'CEX', value: 0.07),
      VolRow(exchange: 'BFX', value: 0.01),
      VolRow(exchange: 'DYX', value: 0.01),
      VolRow(exchange: 'PRD', value: 0.01),
      VolRow(exchange: 'DFT', value: 0.0),
    ],
  ),
};
