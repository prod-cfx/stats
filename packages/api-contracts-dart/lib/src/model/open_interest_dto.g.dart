...
part of 'open_interest_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$OpenInterestDto extends OpenInterestDto {
  @override
  ...
  factory _$OpenInterestDto([void Function(OpenInterestDtoBuilder)? updates]) =>
      (OpenInterestDtoBuilder()..update(updates))._build();
  ...
  @override
  OpenInterestDto rebuild(void Function(OpenInterestDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OpenInterestDtoBuilder toBuilder() => OpenInterestDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OpenInterestDto &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OpenInterestDto')
...
class OpenInterestDtoBuilder
    implements Builder<OpenInterestDto, OpenInterestDtoBuilder> {
  _$OpenInterestDto? _$v;
  ...
  OpenInterestDtoBuilder() {
    OpenInterestDto._defaults(this);
  }

  OpenInterestDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(OpenInterestDto other) {
    _$v = other as _$OpenInterestDto;
  }

  @override
  void update(void Function(OpenInterestDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  OpenInterestDto build() => _build();

  _$OpenInterestDto _build() {
    final _$result =
        _$v ??
        _$OpenInterestDto._(
