...
/// * [dataTimestamp] - 数据时间戳
@BuiltValue()
abstract class OpenInterestDto implements Built<OpenInterestDto, OpenInterestDtoBuilder> {
  /// 交易所名称，\"All\"表示所有交易所汇总
  ...
  factory OpenInterestDto([void updates(OpenInterestDtoBuilder b)]) = _$OpenInterestDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OpenInterestDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OpenInterestDto> get serializer => _$OpenInterestDtoSerializer();
}

class _$OpenInterestDtoSerializer implements PrimitiveSerializer<OpenInterestDto> {
  @override
  final Iterable<Type> types = const [OpenInterestDto, _$OpenInterestDto];

  @override
  final String wireName = r'OpenInterestDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OpenInterestDto object, {
  ...
  void _deserializeProperties(
    ...
    required OpenInterestDtoBuilder result,
  ...
  @override
  OpenInterestDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OpenInterestDtoBuilder();
