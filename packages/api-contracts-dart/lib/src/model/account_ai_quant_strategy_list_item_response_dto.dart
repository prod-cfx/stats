...
part 'account_ai_quant_strategy_list_item_response_dto.g.dart';
...
abstract class AccountAiQuantStrategyListItemResponseDto implements Built<AccountAiQuantStrategyListItemResponseDto, AccountAiQuantStrategyListItemResponseDtoBuilder> {
  ...
  AccountAiQuantStrategyListItemResponseDto._();

  factory AccountAiQuantStrategyListItemResponseDto([void updates(AccountAiQuantStrategyListItemResponseDtoBuilder b)]) = _$AccountAiQuantStrategyListItemResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountAiQuantStrategyListItemResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountAiQuantStrategyListItemResponseDto> get serializer => _$AccountAiQuantStrategyListItemResponseDtoSerializer();
}

class _$AccountAiQuantStrategyListItemResponseDtoSerializer implements PrimitiveSerializer<AccountAiQuantStrategyListItemResponseDto> {
  @override
  final Iterable<Type> types = const [AccountAiQuantStrategyListItemResponseDto, _$AccountAiQuantStrategyListItemResponseDto];

  @override
  final String wireName = r'AccountAiQuantStrategyListItemResponseDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AccountAiQuantStrategyListItemResponseDto object, {
    ...
    yield serializers.serialize(
      object.status,
      specifiedType: const FullType(AccountAiQuantStrategyListItemResponseDtoStatusEnum),
    );
  ...
  void _deserializeProperties(
    ...
    required AccountAiQuantStrategyListItemResponseDtoBuilder result,
      ...
      switch (key) {
        ...
        case r'status':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(AccountAiQuantStrategyListItemResponseDtoStatusEnum),
          ) as AccountAiQuantStrategyListItemResponseDtoStatusEnum;
  ...
  @override
  AccountAiQuantStrategyListItemResponseDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountAiQuantStrategyListItemResponseDtoBuilder();
...
class AccountAiQuantStrategyListItemResponseDtoStatusEnum extends EnumClass {
  ...
  static Serializer<AccountAiQuantStrategyListItemResponseDtoStatusEnum> get serializer => _$accountAiQuantStrategyListItemResponseDtoStatusEnumSerializer;

  const AccountAiQuantStrategyListItemResponseDtoStatusEnum._(String name): super(name);

  static BuiltSet<AccountAiQuantStrategyListItemResponseDtoStatusEnum> get values => _$accountAiQuantStrategyListItemResponseDtoStatusEnumValues;
  static AccountAiQuantStrategyListItemResponseDtoStatusEnum valueOf(String name) => _$accountAiQuantStrategyListItemResponseDtoStatusEnumValueOf(name);
}
