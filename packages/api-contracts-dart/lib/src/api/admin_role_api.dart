...
class AdminRoleApi {
  ...
  const AdminRoleApi(this._dio, this._serializers);
  ...
  Future<Response<AdminDeleteResultResponseDto>> adminRoleControllerDelete0({ 
    ...
    final _path = r'/admin/role/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminDeleteResultResponseDto>> adminRoleControllerDelete1({ 
    ...
    final _path = r'/admin/roles/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminRoleControllerList0200Response>> adminRoleControllerList0({ 
    ...
    AdminRoleControllerList0200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminRoleControllerList0200Response),
      ) as AdminRoleControllerList0200Response;
    ...
    return Response<AdminRoleControllerList0200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
