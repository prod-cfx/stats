...
class AuthApi {
  ...
  authControllerGetTelegramLoginConfig({
    ...
    AuthControllerGetTelegramLoginConfig200Response? _responseData;
    ...
    return Response<AuthControllerGetTelegramLoginConfig200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  authControllerHandleTelegramBotWebhook({
    ...
    final _path = r'/auth/telegram/bot/webhook';
    final _options = Options(
      method: r'POST',
