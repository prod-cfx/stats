...
class AdminMenuApi {
  ...
  const AdminMenuApi(this._dio, this._serializers);
  ...
  Future<Response<AdminMenuResponseDto>> adminMenuControllerCreate0({ 
    ...
    try {
      const _type = FullType(CreateAdminMenuDto);
      _bodyData = _serializers.serialize(createAdminMenuDto, specifiedType: _type);
  ...
  Future<Response<AdminDeleteResultResponseDto>> adminMenuControllerDelete0({ 
    ...
    final _path = r'/admin/menu/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminDeleteResultResponseDto>> adminMenuControllerDelete1({ 
    ...
    final _path = r'/admin/menus/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AdminMenuResponseDto>>> adminMenuControllerFindFlat1({ 
    ...
    final _path = r'/admin/menus/flat';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AdminMenuPermissionDto>>> adminMenuControllerFindPermissionMenus0({ 
    ...
    final _path = r'/admin/menu/permission';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AdminMenuPermissionDto>>> adminMenuControllerFindPermissionMenus1({ 
    ...
    final _path = r'/admin/menus/permission';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<AdminMenuResponseDto>> adminMenuControllerUpdate0({ 
    ...
    try {
      const _type = FullType(UpdateAdminMenuDto);
      _bodyData = _serializers.serialize(updateAdminMenuDto, specifiedType: _type);
