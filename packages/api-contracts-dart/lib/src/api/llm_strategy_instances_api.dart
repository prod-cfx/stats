...
class LlmStrategyInstancesApi {
  ...
  Future<Response<LlmStrategyInstanceResponseDto>> llmStrategyInstancesControllerDetail({
    ...
    final _path = r'/llm-strategy-instances/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  Future<Response<LlmStrategyInstancesControllerList200Response>> llmStrategyInstancesControllerList({
    ...
    final _path = r'/llm-strategy-instances';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<LlmStrategyInstancesControllerSignals200Response>> llmStrategyInstancesControllerSignals({
    ...
    final _path = r'/llm-strategy-instances/{id}/signals'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
